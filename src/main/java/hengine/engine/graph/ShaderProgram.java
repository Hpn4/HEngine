...
public class ShaderProgram {
	...
	public void createMaterialUniform(final String uniformName) throws Exception {
		...
		createUniform(uniformName + ".specularFactor");
	...
	public void setMaterial(final String uniformName, final Material material) {
		...
		setFloat(uniformName + ".specularFactor", material.getSpecularFactor());
		setVector3f(uniformName + ".emissive", material.getEmissiveColour());
		...
		// On est codé que sur 8 bit ouais je sait c'est de la merde mais du coups je
		// peux pas mettre des qu'entre 0 et 1
		final float reflect = 256.0f / material.getShininess();

		setFloat(uniformName + ".shininess", reflect);
	}
