...
public class ShadowRenderer {
	...
	private void setupDepthShader() throws Exception {
		depthShaderProgram = new ShaderProgram("shadow/depth");
	...
	private void setupAnimDepthShader() throws Exception {
		animDepthShaderProgram = new ShaderProgram("shadow/depth_animated.vert", null, "shadow/depth.frag");
	...
	private void setupAlphaDepthShader() throws Exception {
		alphaDepthShaderProgram = new ShaderProgram("shadow/depth_alpha");
