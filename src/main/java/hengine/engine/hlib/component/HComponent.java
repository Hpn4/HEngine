...
import hengine.engine.hlib.css.HComponentStyle;
...
import hengine.engine.hlib.event.listener.KeyListener;
import hengine.engine.hlib.event.listener.MouseListener;
...
public abstract class HComponent {
	...
	private HComponentStyle defaultStyle;
	...
	public static void cleanUpStatic(final long ctx) {
		colorEntered.cleanUp(ctx);
		colorDefault.cleanUp(ctx);
	}
	...
	public void setDefaultStyle(final HComponentStyle defaultStyle) {
		this.defaultStyle = defaultStyle;
	}

	public HComponentStyle getDefaultStyle() {
		return defaultStyle;
	}

	public void addplyDefaultStyle() {
